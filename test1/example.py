...
creator_mnemonic = "vocal guard vintage kitten hood vacant calm naive foot shove vapor thunder sign friend bleak bean only between dream drum two range bounce about sing"
user_mnemonic = "vocal guard vintage kitten hood vacant calm naive foot shove vapor thunder sign friend bleak bean only between dream drum two range bounce about sing"

# user declared algod connection parameters. Node must have EnableDeveloperAPI set to true in its config
algod_address = "http://localhost:43635"
algod_token = "d2aee262bb4b7ba49e0989c039093e6794b99e53355b804010b56f01d696c7a5"
